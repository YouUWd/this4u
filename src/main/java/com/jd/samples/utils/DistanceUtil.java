...
public class DistanceUtil {
	...
	public static double[] getAround(double lat, double lon, int raidus) {
		...
		System.out.println("[" + minLat + "," + minLng + "," + maxLat + ","
				+ maxLng + "]");
		return new double[] { minLat, minLng, maxLat, maxLng };
	}

	/**
	 * 根据两点间经纬度坐标（double值），计算两点间距离，单位为米 lat（经度），lng （纬度）
	 * 
	 * @param lng1
	 * @param lat1
	 * @param lng2
	...
	public static void main(String[] args) {
		...
		double dis = getDistance(lat1, lon1, 34.25566276027792, 108.94186385411045);
		// Distance is:8184.0
